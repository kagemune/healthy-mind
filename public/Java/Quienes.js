...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactButton) {
        ...
        // INTEGRACIÓN MODAL EMAIL: Evitar que el correo predeterminado se abra al hacer clic en el enlace
    ...
    function openModal() {
        if (modal) {
            ...
            // Evitar que se haga scroll en la página mientras la modal está abierta
    ...
    // Hacer clic fuera de la modal para cerrarla
    if (modal) {
    ...
    if (copyButton) {
        copyButton.addEventListener('click', function() {
            const emailText = document.querySelector('.email-display').textContent.trim();
